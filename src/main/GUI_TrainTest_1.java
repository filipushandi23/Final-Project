 ...
 * @author Filipus
 */
public class GUI_TrainTest_1 extends javax.swing.JFrame {
    ...
    private void trainDataBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_trainDataBtnActionPerformed
        ...
        //parameter
                ...
                String path = "C:\\Users\\Filipus\\Documents\\NetBeansProjects\\KlasifikasiSVM\\feature-data\\"+feature+"\\"+feature+"-training-FOREGROUND.csv";
...
//                        System.out.println("===========================");
                        ...
                        String saveModel = "C:\\Users\\Filipus\\Documents\\Flavia Training + Testing 1\\models\\sigma-"+(int) sigma;
        ...
        //parameter
                ...
                try {
                    ...
                    for (int index = 0; index < classes.length; index++) {
                        ...
                        String modelPath = "C:\\Users\\Filipus\\Documents\\Flavia Training + Testing 1\\models\\sigma-" + (int) sigma + "\\" + feature + "\\model-" + classes[index] + ".txt";
                        
                        double[] solutions = RWFile.getDataFromText(modelPath, 961);

//                    //get testing data, create RBF matrix test
                        String pathTest = "C:\\Users\\Filipus\\Documents\\Flavia Training + Testing 1\\feature-data\\" + feature + "\\" + feature + "-testing-FOREGROUND.csv";
...
//                            System.out.println("Result for data-"+(i+1)+" = "+result);
...
//                        System.out.println("Total False Classified : " + falseClassified);
                    ...
                    System.out.println("Accuracy: "+(truePositiveRateAvg/32));
                    textArea.append("Accuracy: "+(truePositiveRateAvg/32)+"\n");
                    textArea.append("\n===============================================\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_TrainTest_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_TrainTest_1().setVisible(true);
            }
        });
    }
