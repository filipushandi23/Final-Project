 ...
 * @author Filipus
 */
public class GUI_TrainTest extends javax.swing.JFrame {
...
//                        System.out.println("Total False Classified : " + falseClassified);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_TrainTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_TrainTest().setVisible(true);
            }
        });
    }
