 ...
 * @author Filipus
 */
public class GUI_TrainTest_2 extends javax.swing.JFrame {
...
//                        System.out.println("===========================");
                        ...
                        String saveModel = "C:\\Users\\Filipus\\Documents\\Flavia Training + Testing 2\\models\\sigma-"+(int) sigma;
        ...
        //parameter
                ...
                try {
                    ...
                    for (int index = 0; index < classes.length; index++) {
                        ...
                        String modelPath = "C:\\Users\\Filipus\\Documents\\Flavia Training + Testing 2\\models\\sigma-" + (int) sigma + "\\" + feature + "\\model-" + classes[index] + ".txt";
                        
                        double[] solutions = RWFile.getDataFromText(modelPath, 961);

//                    //get testing data, create RBF matrix test
                        String pathTest = "C:\\Users\\Filipus\\Documents\\Flavia Training + Testing 2\\feature-data\\" + feature + "\\" + feature + "-testing.csv";
...
//                        System.out.println("Total False Classified : " + falseClassified);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_TrainTest_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_TrainTest_2().setVisible(true);
            }
        });
    }
